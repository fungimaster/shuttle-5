      ...
      <b-container class="d-flex">
        ...
        <b-row>
          <b-col class="col-12 col-md-12">  
            ...
            <app-grafic style="height: 300px" textColor="text-light"></app-grafic>
...
.hero {
  background: url(https://res.cloudinary.com/dn3hzwewp/image/upload/c_scale,w_1900,q_70/v1572963227/matchplay/c640cf_76573b7e69c04dc2bb0592399d738a17_mv2_d_4006_3000_s_4_2.jpg);
