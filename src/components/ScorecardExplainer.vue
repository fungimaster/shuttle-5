...
export default {
  ...
  data() {
    return {
      ...
      slides: [
         {
         message: 'När ni har träffats på klubben (eller inomhusanläggning om Indoortävling) och det är dags för spel startar hemmalaget (som ansvarar för att föra score) matchen från matchplay.se och matchsidan. Aktuell hcp hämtas direkt från GIT och val av tee görs.',
      ...
      { message: 'På resp. hål förs varje spelares score in genom ett enkelt gränssnitt, det tar i snitt 3-5 sekunder att mata in scoren för ett hål och sedan gå vidare till nästa. Familj och vänner kan följa matchen på matchplay.se. Behövs särspel efter 18:e hålet vinner laget med lägst sammanlagd hcp.',
