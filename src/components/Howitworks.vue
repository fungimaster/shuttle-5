...
export default {
 ...
 //explainer
      explainer: [      
        { icon: 'clipboard-check',title:'Anmälan', message: "Steg 1 är att anmäla dig som spelare under 'Anmälan' där du direkt får besked om du är kvalificerad. Du blir sedan inloggad för att påbörja ditt lagbygge. Inget förbinder dig att betala för ditt lag i detta läge. Anmälan stänger den 20 augusti." },
        ...
        { icon: 'trophy', title: 'Vinnande lag', message: "De vinnande lagen Local Series Stockholm och Local Series Malmö åker med Matchplay till Golf Le Fonti, Bologna, för att göra upp om titeln. Flyg, hotell och allt spel ingår för all lagen." },
