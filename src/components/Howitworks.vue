...
export default {
 ...
 //explainer
      explainer: [      
        ...
        { icon: 'trophy', title: 'Vinnande lag', message: "De vinnande lagen Local Series Stockholm och Local Series Skåne åker med Matchplay till Golf Le Fonti, Bologna, för att göra upp om titeln. Flyg, hotell och allt spel ingår för all lagen." },
