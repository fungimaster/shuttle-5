...
export default {
 ...
 //explainer
      explainer: [      
        ...
        { icon: 'clipboard-check',title:'Anmälan', message: "Steg 1 är att anmäla dig som spelare under 'Anmälan' där du direkt får besked om du är kvalificerad. Du blir sedan inloggad för att påbörja ditt lagbygge. <strong>Inget</strong> förbinder dig att betala för ditt lag i detta läge. Anmälan stänger den 6 januari 2023." },
        ...
        { icon: 'dice', title: 'Lottning', message: "Den 7 januari görs lottningen för den första omgången och där tas det hänsyn till att alla lag ska få så kort resa som möjligt. Du kommer få information via mail samt på matchplay.se när lottningen är klar och du kan då se vilket lag ni kommer möta. Möter du ett lag från annan ort kan matchen spelas digitalt samtidigt på 2 anläggningar." },
        { icon: 'golf-ball', title: 'Spela matcher', message: "Varje match måste spelas inom den period som anges för den lottande omgången. På indoor.matchplay.se kommer du kunna se vilket lag ni ska möta samt kontaktuppgifter. Fram till Sverigefinalen betalar ni själva för tidsbokning av inomhusanläggningen. All score förs med vårt digitala scorekort." },
