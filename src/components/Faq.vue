...
<div class="section first" id="1">
					...
					<div class="section" id="4">
						...
						<p>Matchplay spelas i 2-mannalag (herrlag, damlag eller mixade lag) Alla deltagare måste ha officiellt HCP. Man behöver inte vara anställd av ett företag man representerar i ett företagslag.</p>
					</div>

					<div class="section" id="5">
						<h3 class="pt-5">5. ÅLDERSGRÄNS FÖR DELTAGANDE</h3>
						<p>Båda spelarna måste fylla minst 18 år innan tävlingsstart.</p>
					</div>
...
Vid omstart hål 1 (alt. Hål 10) så gäller det att det finns plats såklart. Lagen ska vänta i maximalt 30 minuter för spel annars siktar man på punkt 3.
					...
					<div class="section" id="9">
						...
						<div class="section" id="10">
							...
							<p>Lottning kommer att ske efter att registreringen stängs. Matchplay har prioriteringar i lottningen som gäller geografisk tillhörighet. Detta ger kortast möjliga resor under hela tävlingen fram mot Sverigefinalen.</p>
						...
						<div class="section" id="12">
							...
							<p>
								...
								Sverigefinalen spelas runt september 2021 på plats som meddelas när vi vet var de kvarvarande lagen finns geografiskt. Majoriteten av kvarvarande lag avgör plats. Spelformen är samma under Sverigefinalen som i grundomgången. Alla deltagare i Sverigefinalen har redan kvalificerat sig för spel nästkommande år utan kostnad. Vinnarna går vidare till finalspelet som sker utomlands (oktober 2021), på plats som meddelas januari 2021. Förutom det stora vandringspriset, tävlar man om ett prisbord sammansatt av sponsorer.
							</p>
						</div>
						...
						<div class="section">
							...
							<p>
								Alla generella tävlingsregler som gäller för Sverige och går under Svenska Golfförbundet används i Matchplay rörande Bästboll/Matchspel. Oklarheter gällande regelverket – kontakta tävlingsledningen på
								<a
									href="mailto:info@matchplay.se"
								>info@matchplay.se</a>.
							</p>
