      ...
      <b-row>
        <b-col xl="1"></b-col>
         <b-col class="mt-5 col-12">    
           Nedan finner du all information om tävlingen samt ett antal snabblänkar till de viktigaste punkterna. Hittar du inte vad du söker efter så kontakta oss på <a href="mailto:info@matchplay.se">info@matchplay.se</a>.
         </b-col>
        <b-col class="mt-5 col-12">         
...
<div class="section" id="5">
            ...
            <p>Båda spelarna måste fylla minst 18 år innan tävlingsstart.
</p>
</div>
...
<div class="section" id="18">
            ...
            <p>Om det av någon anledning uppkommer en eller flera situationer som föranleder att ni vill lämna in en protest, så ska detta göras skriftligen via mail till <a href="mailto:info@matchplay.se">info@matchplay.se</a>. Protesten måste inkomma senast dagen efter spel. Protester inkomna senare än detta kommer inte att behandlas.
</p>
</div>
...
<div class="section" id="20">
            ...
            <p>Matchplay består av en ”Huvudtävling” och en ”Andra Chansen” vilka skapas efter den första omgången, där förlorarna får en andra chans att nå finalspelet. Lag och vägen från Andra Chansen till finalen kommer att vara aningens svårare, då färre lag går vidare än från Huvudtävlingen.
</p>

</div>
<div class="section">
            <h3 class="pt-5">TÄVLINGSLEDNING / TÄVLINGSBESTÄMMELSERNA / TÄVLINGSREGLERNA</h3>
            <p>Alla generella tävlingsregler som gäller för Sverige och går under Svenska Golfförbundet används i Matchplay rörande Bästboll/Matchspel. Oklarheter gällande regelverket – kontakta tävlingsledningen på <a href="mailto:info@matchplay.se">info@matchplay.se</a>.
</p>
</div>
