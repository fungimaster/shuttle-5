          ...
          <li>{{ hole.hole }} : {{ hole.slag }}</li>
            ...
            singleHoleWinner > 0 && displayToast === false ? 'holeLoser' : ''
				...
				>
							...
							<b-col>
								<div v-if="index === 0">
									<button
										...
										v-b-modal.modal-1
										v-if="currentStrokesList.slice(0, 1)[0] !== currentStrokesList.slice(0, 1)[0]"
									>-</button>
									<button
										class="btn btn-warning"
										v-b-modal.modal-1
								...
								<div v-if="index === 1">
									<button
										class="btn btn-warning"
										v-b-modal.modal-2
										v-if="currentStrokesList.slice(1, 2)[0] !== currentStrokesList.slice(1, 2)[0]"
									>-</button>
									<button
										class="btn btn-warning"
										v-b-modal.modal-2
					...
					<!-- Kollar om slaget inte är lika med sig själv (dvs om det är NaN) och sätter det i så fall lika med "-" -->
            ...
            singleHoleWinner < 0 && displayToast === false ? 'holeLoser' : ''
				...
				>Nästa hål</button>
				<button class="btn btn-primary" @click="overview = !overview">Översikt</button>
		...
		<div v-if="overview" id="overview">
			<b-container>
                ...
                par: holes.par
						...
						<td v-for="score in playerScoreFrontNine.slice(1, 2)" :key="score.index" v-bold>{{ score }}</td>
					</tr>
                ...
                par: holes.par
						...
						>{{ holes.strokes === 0 ? null : holes.strokes }}</td>
						<td v-for="score in playerScoreFrontNine.slice(2, 3)" :key="score.index" v-bold>{{ score }}</td>
					</tr>
                ...
                par: holes.par
						...
						>{{ holes.strokes === 0 ? null : holes.strokes }}</td>
						<td v-for="score in playerScoreFrontNine.slice(3, 4)" :key="score.index" v-bold>{{ score }}</td>
					</tr>
				</table>
                ...
                par: holes.par
						...
						>{{ holes.strokes === 0 ? null : holes.strokes }}</td>
						<td v-for="score in playerScoreBackNine.slice(0, 1)" :key="score.index" v-bold>{{ score }}</td>
                ...
                par: holes.par
						...
						>{{ holes.strokes === 0 ? null : holes.strokes }}</td>
						<td v-for="score in playerScoreBackNine.slice(1, 2)" :key="score.index" v-bold>{{ score }}</td>
                ...
                par: holes.par
						...
						>{{ holes.strokes === 0 ? null : holes.strokes }}</td>
						<td v-for="score in playerScoreBackNine.slice(2, 3)" :key="score.index" v-bold>{{ score }}</td>
                ...
                par: holes.par
						...
						>{{ holes.strokes === 0 ? null : holes.strokes }}</td>
						<td v-for="score in playerScoreBackNine.slice(3, 4)" :key="score.index" v-bold>{{ score }}</td>
						<td v-for="score in playerScoreTotal.slice(3, 4)" :key="score.index" v-bold>{{ score }}</td>
					</tr>
				</table>

				<!-- BUTTON FÖR MATCH VY -->
				<button class="btn btn-primary" @click="overview = !overview">Match Vy</button>
			</b-container>
		</div>
	</div>
</template>
	...
	export default {
		...
		directives: {
			changeNanAndZero(el, bind) {
				if (bind.value.slag !== bind.value.slag) {
					el.innerHTML = "-";
				}
